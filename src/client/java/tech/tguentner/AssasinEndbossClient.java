...
import tech.tguentner.entity.client.renderer.SkelettMagierRenderer;
...
public class AssasinEndbossClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		EntityRendererRegistry.register(ModEntities.SKELETT_MAGIER, SkelettMagierRenderer::new);
